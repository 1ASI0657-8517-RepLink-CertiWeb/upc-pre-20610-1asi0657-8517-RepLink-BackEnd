...
using CertificateSignatureVO = CertiWeb.API.Certifications.Domain.Model.ValueObjects.CertificateSignature;

namespace CertiWeb.API.Vehicles.Domain.Model.Aggregates;
...
public class Car
{
    ...
    public Car(CreateCarCommand command)
    {
        ...
        CertificateSignature = CertificateSignatureVO
            .Generate(
